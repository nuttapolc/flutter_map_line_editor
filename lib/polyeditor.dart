  ...
  List<DragMarker> edit() {
    ...
    for (var c = 0; c < this.points.length; c++) {
      ...
      dragMarkers.add(DragMarker(
          ...
          builder: (ctx) => Container(child: this.pointIcon),
          onDragStart: (_, __) {
    ...
    for (var c = 0; c < this.points.length - 1; c++) {
      ...
      var indexClosure = c;
      var intermediatePoint = new LatLng(
      ...
      dragMarkers.add(DragMarker(
        ...
        builder: (ctx) => Container(child: this.intermediateIcon),
    ...
    if (addClosePathMarker && (this.points.length > 2)) {
      ...
      var intermediatePoint = new LatLng(
          this.points[finalPointIndex].latitude +
              (this.points[0].latitude -
                      this.points[finalPointIndex].latitude) /
                  2,
          this.points[finalPointIndex].longitude +
